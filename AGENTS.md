...
- **Java 64-bit** (11+)
- **SBT** (1.4.4+)
- **Z3 executable** (4.8.7 64-bit, the version used in CI; newer Z3 versions are not drop-in
  replacements, see `workflow-container/Dockerfile`) — set `Z3_EXE=/path/to/z3`
