...
2. Clone Gobra and Viper dependencies
    ...
    - [silver](https://github.com/viperproject/silver) (tag  `v.22.02-release`)
    - [silicon](https://github.com/viperproject/silicon) (tag `v.22.02-release`)
    - [carbon](https://github.com/viperproject/carbon) (tag `v.22.02-release`)
    - [viperserver](https://github.com/viperproject/viperserver) (tag `v.22.02-release`)
    - Gobra
