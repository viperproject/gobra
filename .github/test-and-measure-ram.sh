...
# it seems that sbt on it's own thinks that colors cannot be displayed when run in docker and thus turns them
# off by default.
# sbt test
sbt -Dsbt.color=always "testOnly *ExprTypingUnitTests"
TEST_RES=$?
