...
public class GobraParser extends GobraParserBase {
	...
	public static final int
		...
		WRITEPERM=66, NOPERM=67, TRUSTED=68, OUTLINE=69, DUPLICABLE=70, PKG_INV=71, 
		OPEN_DUP_SINV=72, INIT_POST=73, INIT_PRE=74, IMPORT_PRE=75, PROOF=76, 
		GHOST_EQUALS=77, GHOST_NOT_EQUALS=78, WITH=79, OPAQUE=80, MAYINIT=81, 
		REVEAL=82, BACKEND=83, FRIENDPKG=84, BREAK=85, DEFAULT=86, FUNC=87, INTERFACE=88, 
		SELECT=89, CASE=90, DEFER=91, GO=92, MAP=93, STRUCT=94, CHAN=95, ELSE=96, 
		GOTO=97, PACKAGE=98, SWITCH=99, CONST=100, FALLTHROUGH=101, IF=102, RANGE=103, 
		TYPE=104, CONTINUE=105, FOR=106, IMPORT=107, RETURN=108, VAR=109, NIL_LIT=110, 
		IDENTIFIER=111, L_PAREN=112, R_PAREN=113, L_CURLY=114, R_CURLY=115, L_BRACKET=116, 
		R_BRACKET=117, ASSIGN=118, COMMA=119, SEMI=120, COLON=121, DOT=122, PLUS_PLUS=123, 
		MINUS_MINUS=124, DECLARE_ASSIGN=125, ELLIPSIS=126, LOGICAL_OR=127, LOGICAL_AND=128, 
		EQUALS=129, NOT_EQUALS=130, LESS=131, LESS_OR_EQUALS=132, GREATER=133, 
		GREATER_OR_EQUALS=134, OR=135, DIV=136, MOD=137, LSHIFT=138, RSHIFT=139, 
		BIT_CLEAR=140, EXCLAMATION=141, PLUS=142, MINUS=143, CARET=144, STAR=145, 
		AMPERSAND=146, RECEIVE=147, DECIMAL_LIT=148, BINARY_LIT=149, OCTAL_LIT=150, 
		HEX_LIT=151, HEX_FLOAT_LIT=152, IMAGINARY_LIT=153, RUNE_LIT=154, BYTE_VALUE=155, 
		OCTAL_BYTE_VALUE=156, HEX_BYTE_VALUE=157, LITTLE_U_VALUE=158, BIG_U_VALUE=159, 
		RAW_STRING_LIT=160, INTERPRETED_STRING_LIT=161, WS=162, COMMENT=163, TERMINATOR=164, 
		LINE_COMMENT=165, WS_NLSEMI=166, COMMENT_NLSEMI=167, LINE_COMMENT_NLSEMI=168, 
		EOS=169, OTHER=170;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DUPLICABLE", "PKG_INV", "OPEN_DUP_SINV", "INIT_POST", "INIT_PRE", "IMPORT_PRE", 
			"PROOF", "GHOST_EQUALS", "GHOST_NOT_EQUALS", "WITH", "OPAQUE", "MAYINIT", 
			"REVEAL", "BACKEND", "FRIENDPKG", "BREAK", "DEFAULT", "FUNC", "INTERFACE", 
	...
	public final SourceFileContext sourceFile() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 74)) & ~0x3f) == 0 && ((1L << (_la - 74)) & 8589934595L) != 0)) {
				{
				{
				setState(439);
				importDecl();
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 166702455579504128L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 310135529975809L) != 0) || _la==STAR || _la==RECEIVE) {
				{
				{
				setState(450);
				_errHandler.sync(this);
	...
	public final ImportDeclContext importDecl() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((((_la - 74)) & ~0x3f) == 0 && ((1L << (_la - 74)) & 281612415664131L) != 0) || _la==RAW_STRING_LIT || _la==INTERPRETED_STRING_LIT) {
					{
					{
					setState(532);
					importSpec();
	...
	public final AdtClauseContext adtClause() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 166702455579475968L) != 0) || ((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & 1441151881345761731L) != 0)) {
				{
				{
				setState(777);
				adtFieldDecl();
	...
	public final BackendAnnotationEntryContext backendAnnotationEntry() throws RecognitionException {
		...
		try {
			...
			do {
				...
				setState(851);
				_la = _input.LA(1);
				if ( _la <= 0 || (((((_la - 112)) & ~0x3f) == 0 && ((1L << (_la - 112)) & 131L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & -2L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -36873221949095937L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & 8796093022207L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SingleBackendAnnotationContext singleBackendAnnotation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -36873221949095937L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & 8796093022207L) != 0)) {
				{
				setState(866);
				listOfValues();
				}
	...
	public final MatchPatternContext matchPattern() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1143913343522074138L) != 0) || ((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 1249458472075271L) != 0) || ((((_la - 141)) & ~0x3f) == 0 && ((1L << (_la - 141)) & 1587199L) != 0)) {
					{
					setState(933);
					matchPatternList();
					setState(935);
	...
	public final ClosureSpecInstanceContext closureSpecInstance() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1143913206083120666L) != 0) || ((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 1249458472075271L) != 0) || ((((_la - 141)) & ~0x3f) == 0 && ((1L << (_la - 141)) & 1587199L) != 0)) {
					{
					setState(969);
					closureSpecParams();
					setState(971);
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 141)) & ~0x3f) == 0 && ((1L << (_la - 141)) & 127L) != 0)) ) {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						_la = _input.LA(1);
						if ( !(((((_la - 136)) & ~0x3f) == 0 && ((1L << (_la - 136)) & 1567L) != 0)) ) {
					...
					case 2:
						...
						_la = _input.LA(1);
						if ( !(_la==WAND || ((((_la - 123)) & ~0x3f) == 0 && ((1L << (_la - 123)) & 3674113L) != 0)) ) {
					...
					case 5:
						...
						_la = _input.LA(1);
						if ( !(((((_la - 77)) & ~0x3f) == 0 && ((1L << (_la - 77)) & 283726776524341251L) != 0)) ) {
	...
	private PrimaryExprContext primaryExpr(int _p) throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 46)) & ~0x3f) == 0 && ((1L << (_la - 46)) & 144115188075855945L) != 0)) ) {
	...
	public final InterfaceTypeContext interfaceType() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 144115188210101760L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 8796093067265L) != 0)) {
				{
				{
				setState(1347);
				_errHandler.sync(this);
	...
	public final PredTypeParamsContext predTypeParams() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 166702455579475968L) != 0) || ((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & 1441151881345761731L) != 0)) {
				{
				setState(1403);
				type_();
				setState(1408);
	...
	public final Assign_opContext assign_op() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 135)) & ~0x3f) == 0 && ((1L << (_la - 135)) & 4031L) != 0)) {
				{
				setState(1458);
	...
	public final ParametersContext parameters() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 166702455579475968L) != 0) || ((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & 1441152431101575619L) != 0)) {
				{
				setState(1844);
				parameterDecl();
				setState(1849);
	...
	public final IntegerContext integer() throws RecognitionException {
		...
		try {
			...
			setState(1887);
			_la = _input.LA(1);
			if ( !(((((_la - 148)) & ~0x3f) == 0 && ((1L << (_la - 148)) & 111L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final LiteralValueContext literalValue() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1143913206083120666L) != 0) || ((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 1530933448785927L) != 0) || ((((_la - 141)) & ~0x3f) == 0 && ((1L << (_la - 141)) & 1587199L) != 0)) {
				{
				setState(1899);
				elementList();
				setState(1901);
