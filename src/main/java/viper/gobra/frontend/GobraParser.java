...
public class GobraParser extends GobraParserBase {
	...
	public static final int
		...
		LOW=60, LOWC=61, SHARE=62, ADDR_MOD=63, DOT_DOT=64, SHARED=65, EXCLUSIVE=66, 
		PREDICATE=67, WRITEPERM=68, NOPERM=69, TRUSTED=70, OUTLINE=71, INIT_POST=72, 
		IMPORT_PRE=73, PROOF=74, GHOST_EQUALS=75, GHOST_NOT_EQUALS=76, WITH=77, 
		OPAQUE=78, REVEAL=79, BACKEND=80, BREAK=81, DEFAULT=82, FUNC=83, INTERFACE=84, 
		SELECT=85, CASE=86, DEFER=87, GO=88, MAP=89, STRUCT=90, CHAN=91, ELSE=92, 
		GOTO=93, PACKAGE=94, SWITCH=95, CONST=96, FALLTHROUGH=97, IF=98, RANGE=99, 
		TYPE=100, CONTINUE=101, FOR=102, IMPORT=103, RETURN=104, VAR=105, NIL_LIT=106, 
		IDENTIFIER=107, L_PAREN=108, R_PAREN=109, L_CURLY=110, R_CURLY=111, L_BRACKET=112, 
		R_BRACKET=113, ASSIGN=114, COMMA=115, SEMI=116, COLON=117, DOT=118, PLUS_PLUS=119, 
		MINUS_MINUS=120, DECLARE_ASSIGN=121, ELLIPSIS=122, LOGICAL_OR=123, LOGICAL_AND=124, 
		EQUALS=125, NOT_EQUALS=126, LESS=127, LESS_OR_EQUALS=128, GREATER=129, 
		GREATER_OR_EQUALS=130, OR=131, DIV=132, MOD=133, LSHIFT=134, RSHIFT=135, 
		BIT_CLEAR=136, EXCLAMATION=137, PLUS=138, MINUS=139, CARET=140, STAR=141, 
		AMPERSAND=142, RECEIVE=143, DECIMAL_LIT=144, BINARY_LIT=145, OCTAL_LIT=146, 
		HEX_LIT=147, HEX_FLOAT_LIT=148, IMAGINARY_LIT=149, RUNE_LIT=150, BYTE_VALUE=151, 
		OCTAL_BYTE_VALUE=152, HEX_BYTE_VALUE=153, LITTLE_U_VALUE=154, BIG_U_VALUE=155, 
		RAW_STRING_LIT=156, INTERPRETED_STRING_LIT=157, WS=158, COMMENT=159, TERMINATOR=160, 
		LINE_COMMENT=161, WS_NLSEMI=162, COMMENT_NLSEMI=163, LINE_COMMENT_NLSEMI=164, 
		EOS=165, OTHER=166;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"PRED", "TYPE_OF", "IS_COMPARABLE", "LOW", "LOWC", "SHARE", "ADDR_MOD", 
	...
	public final SourceFileContext sourceFile() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 166702455579504128L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 4845867656449L) != 0) || _la==STAR || _la==RECEIVE) {
				{
				{
				setState(430);
				_errHandler.sync(this);
	...
	public final ImportDeclContext importDecl() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((((_la - 73)) & ~0x3f) == 0 && ((1L << (_la - 73)) & 35201551958017L) != 0) || _la==RAW_STRING_LIT || _la==INTERPRETED_STRING_LIT) {
					{
					{
					setState(490);
					importSpec();
	...
	public final AdtClauseContext adtClause() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 166702455579475968L) != 0) || ((((_la - 83)) & ~0x3f) == 0 && ((1L << (_la - 83)) & 1441151881345761731L) != 0)) {
				{
				{
				setState(745);
				adtFieldDecl();
	...
	public final BackendAnnotationEntryContext backendAnnotationEntry() throws RecognitionException {
		...
		try {
			...
			do {
				...
				setState(817);
				_la = _input.LA(1);
				if ( _la <= 0 || (((((_la - 108)) & ~0x3f) == 0 && ((1L << (_la - 108)) & 131L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & -2L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -2304576371818497L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & 549755813887L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SingleBackendAnnotationContext singleBackendAnnotation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -2304576371818497L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & 549755813887L) != 0)) {
				{
				setState(832);
				listOfValues();
				}
	...
	public final MatchPatternContext matchPattern() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4602677857342615066L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 19522788629511L) != 0) || ((((_la - 137)) & ~0x3f) == 0 && ((1L << (_la - 137)) & 1587199L) != 0)) {
					{
					setState(899);
					matchPatternList();
					setState(901);
	...
	public final ClosureSpecInstanceContext closureSpecInstance() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4602677719903661594L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 19522788629511L) != 0) || ((((_la - 137)) & ~0x3f) == 0 && ((1L << (_la - 137)) & 1587199L) != 0)) {
					{
					setState(935);
					closureSpecParams();
					setState(937);
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 137)) & ~0x3f) == 0 && ((1L << (_la - 137)) & 127L) != 0)) ) {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						_la = _input.LA(1);
						if ( !(((((_la - 132)) & ~0x3f) == 0 && ((1L << (_la - 132)) & 1567L) != 0)) ) {
					...
					case 2:
						...
						_la = _input.LA(1);
						if ( !(_la==WAND || ((((_la - 119)) & ~0x3f) == 0 && ((1L << (_la - 119)) & 3674113L) != 0)) ) {
					...
					case 5:
						...
						_la = _input.LA(1);
						if ( !(((((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & 70931694131085315L) != 0)) ) {
	...
	private PrimaryExprContext primaryExpr(int _p) throws RecognitionException {
		...
		try {
			...
			case 8:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 46)) & ~0x3f) == 0 && ((1L << (_la - 46)) & 9007199254741065L) != 0)) ) {
	...
	public final InterfaceTypeContext interfaceType() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 144115188210101760L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 137438954753L) != 0)) {
				{
				{
				setState(1313);
				_errHandler.sync(this);
	...
	public final PredTypeParamsContext predTypeParams() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 166702455579475968L) != 0) || ((((_la - 83)) & ~0x3f) == 0 && ((1L << (_la - 83)) & 1441151881345761731L) != 0)) {
				{
				setState(1369);
				type_();
				setState(1374);
	...
	public final Assign_opContext assign_op() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & 4031L) != 0)) {
				{
				setState(1424);
	...
	public final ParametersContext parameters() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 166702455579475968L) != 0) || ((((_la - 83)) & ~0x3f) == 0 && ((1L << (_la - 83)) & 1441152431101575619L) != 0)) {
				{
				setState(1810);
				parameterDecl();
				setState(1815);
	...
	public final IntegerContext integer() throws RecognitionException {
		...
		try {
			...
			setState(1853);
			_la = _input.LA(1);
			if ( !(((((_la - 144)) & ~0x3f) == 0 && ((1L << (_la - 144)) & 111L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final LiteralValueContext literalValue() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4602677719903661594L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 23920835140615L) != 0) || ((((_la - 137)) & ~0x3f) == 0 && ((1L << (_la - 137)) & 1587199L) != 0)) {
				{
				setState(1865);
				elementList();
				setState(1867);
